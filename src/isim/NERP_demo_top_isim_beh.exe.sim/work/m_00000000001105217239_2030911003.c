...
static const char *ng20 = "random %d";
static unsigned int ng21[] = {127U, 0U};
static const char *ng22 = "init state: layout = %b, color = %b, dist = %b, %b";
static unsigned int ng23[] = {13U, 0U};
static const char *ng24 = "next layout is %d based on prev layout %d";
static const char *ng25 = "baseX = %d, baseY = %d, nbX = %d, nbY = %d";
static const char *ng26 = "diffX = %d, diffY = %d";
static const char *ng27 = "prev state: layout = %b, color = %b, dist = %d, %d";
static const char *ng28 = "new state: layout = %b, color = %b, dist = %d, %d";
static int ng29[] = {2, 0};
...
LAB38:
LAB39:    t65 = (t1 + 6864);
    xsi_vlogfile_write(1, 0, 0, ng20, 2, t65, (char)118, t33, 32);
    ...
    *((unsigned int *)t18) = (t50 & 255U);
    t20 = (t1 + 6864);
    xsi_vlogfile_write(1, 0, 0, ng22, 5, t20, (char)118, t6, 2, (char)118, t9, 3, (char)118, t27, 8, (char)118, t33, 8);
...
LAB29:    t130 = (t1 + 13032);
    ...
    *((unsigned int *)t12) = t45;
    t14 = (t1 + 7296);
    xsi_vlogfile_write(1, 0, 0, ng24, 3, t14, (char)118, t8, 1, (char)118, t5, 1);
...
LAB21:    t33 = (t2 + 64U);
    ...
    t33 = *((char **)t32);
    t35 = (t1 + 7728);
    xsi_vlogfile_write(1, 0, 0, ng25, 5, t35, (char)118, t6, 8, (char)118, t9, 8, (char)118, t25, 8, (char)118, t33, 8);
    ...
    t9 = *((char **)t8);
    t11 = (t1 + 7728);
    xsi_vlogfile_write(1, 0, 0, ng26, 3, t11, (char)119, t6, 32, (char)119, t9, 32);
...
LAB38:    xsi_set_current_line(250, ng0);
    ...
    *((unsigned int *)t50) = (t30 & 255U);
    t52 = (t1 + 7728);
    xsi_vlogfile_write(1, 0, 0, ng27, 5, t52, (char)118, t31, 2, (char)118, t35, 3, (char)118, t66, 8, (char)118, t68, 8);
    ...
    *((unsigned int *)t43) = (t23 & 255U);
    t45 = (t1 + 7728);
    xsi_vlogfile_write(1, 0, 0, ng28, 5, t45, (char)118, t6, 2, (char)118, t9, 3, (char)118, t10, 8, (char)118, t34, 8);
    goto LAB37;
...
extern void work_m_00000000001105217239_2030911003_init()
{
	...
	xsi_register_didat("work_m_00000000001105217239_2030911003", "isim/NERP_demo_top_isim_beh.exe.sim/work/m_00000000001105217239_2030911003.didat");
